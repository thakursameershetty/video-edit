// AutonomousRoverVideoPage — a pixel-recreation of the "FleetView Assistant" landing
...
const SUGGESTIONS = [
  { icon: Activity, text: "What's the status of Autonomous Rover Development?" },
  { icon: ClipboardList, text: "Create a task in Autonomous Rover Development and assign it to me, due Friday" },
  { icon: ShieldAlert, text: "What's blocking Warehouse Delivery Rover Fleet?" },
  { icon: Flag, text: "Push Warehouse Delivery Rover Fleet's next milestone out by a week" },
...
const AI_TURNS: { title: string; blocks: DocBlock[] }[] = [
  {
    ...
    blocks: [
      section("Overview", [
        p(
          "This document captures the preliminary requirements for a last-mile delivery rover with a 10km one-way operating range, based on the brief provided.",
        ),
      ]),
      section("Requirements Breakdown", [
        reqTree({
          ...
          branches: [
            {
              label: "Chassis & Drivetrain",
              leaves: [
                { type: "Subsystem", id: "CHS-001", label: "Six-wheel chassis", status: "Approved", verification: "Passed" },
                { type: "Subsystem", id: "CHS-002", label: "Motor & gearbox sizing", status: "Approved", verification: "Passed" },
              ],
            },
            {
              label: "Power System",
            ...
            },
            {
              ...
              leaves: [
                { type: "Subsystem", id: "NAV-001", label: "Main controller (F7)", status: "Approved", verification: "Passed" },
                { type: "Subsystem", id: "NAV-002", label: "GPS + IMU redundancy", status: "Reviewed", verification: "In Progress" },
                { type: "Component", id: "NAV-011", label: "Telemetry link (915MHz)", status: "Draft", verification: "Not Verified" },
              ],
            },
            {
            ...
            },
            {
              ...
              leaves: [
                ...
                { type: "Subsystem", id: "SAF-002", label: "Return-to-base failsafe", status: "Approved", verification: "Passed" },
    ...
    blocks: [
        ...
        bomCards(
          [
            ...
            },
            {
              version: "2.0",
              status: "Draft",
              name: "DC gear motors (12V, 200RPM)",
            ...
            },
            {
              version: "5.0",
              status: "Draft",
              name: "Li-ion battery pack (48V 20Ah, swappable)",
            ...
            },
            {
              version: "8.0",
              status: "Draft",
              name: "All-terrain wheels (8in, set)",
      ...
      section("Timeline & Cost Summary", [
        spec([
          ...
          { label: "Target first drive", value: "Day 9" },
        ]),
      ]),
    ],
  },
  {
    ...
    blocks: [
      section("Summary of Changes", [
        p(
          "A few engineering changes from the initial concept, made during the planning pass above. These refine the chassis, power, and navigation decisions to better match the 10km range and 2.5kg payload targets.",
        ),
      ]),
      section("Reason for Change", [
        p(
          "Bench testing of the original single-battery layout showed unacceptable turnaround time between deliveries, and the stock main controller lacked the sensor redundancy needed for reliable autonomous operation over suburban routes.",
        ),
      ]),
      section("Change Log", [
        ul([
          "Switched to swappable battery packs for faster turnaround between deliveries",
          "Upgraded to an F7 main controller for redundant IMU and better autonomy support",
          "Added a payload release mechanism rated for 2.5kg",
          "Increased chassis wheelbase by 12% for wheel clearance with the larger payload bay",
          "Revised wheel guard geometry, reducing rolling resistance by an estimated 6%",
          "Added a secondary GPS antenna for improved signal lock in dense urban canyons",
        ]),
      ]),
      section("Affected Subsystems", [
        spec([
          { label: "Chassis", value: "Wheelbase, wheel guards" },
          { label: "Power system", value: "Battery mount, swap mechanism" },
          { label: "Navigation", value: "Main controller, GPS antenna" },
      ...
      section("Verification & Testing", [
        ul([
          ...
          "Static load test: confirmed wheel clearance at full suspension deflection",
          "Bench test: battery swap timed at under 90 seconds across 10 trials",
          "Field test: 3 test drives at 8km range to validate GPS lock and IMU redundancy",
        ]),
      ]),
...
const AUTO_TYPE_TEXT =
  "Build an autonomous rover for last-mile logistics with operating range of 10km";
...
export default function AutonomousRoverVideoPage() {
